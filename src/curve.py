...
class DiscountCurve:
    ...
    def calcDF(self, t):
        ...
        # interested in. Then we use interpolation to find the correct df value.
    ...
    def rate_from_df(self, time):
        ...
        rate = 1/np.power(df,1/time)-1 # Discrete formula for conversion from discount factor to zero rate
