...
## Zero curve
 ...
 The **par yield** curve is then a graph for bonds of varying lifespans indicating the **par yield** of each hypothetical bond.

 # Discount Factor Curves

**Discount Factor Curves** are far more simple than par yield curves. They plot the discount factor of an arbitrary sum of money relative to today with time. Under the assumption that money is at its most valuable in the present, discount curves must be monotonically decreasing.
...
However, this method has 2 major problems: It may produce 0 or negative **discount factors** which are completely illogical, and it may noy be monotonic, which violates the principle of **TVM.**
...
However, in some cases this method too violates the principle of **TVM** and allows for an increasing discount factor. This method is also noteably scarce in practice.
